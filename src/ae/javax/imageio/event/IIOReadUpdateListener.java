 ...
 * pixel updates.
 *
 * @see ae.javax.imageio.ImageReader#addIIOReadUpdateListener
 * @see ae.javax.imageio.ImageReader#removeIIOReadUpdateListener
 *
 */
public interface IIOReadUpdateListener extends EventListener {
     ...
     * @param theImage the <code>BufferedImage</code> being updated.
     *
     * @see ae.javax.imageio.ImageReadParam#setSourceProgressivePasses(int, int)
     */
