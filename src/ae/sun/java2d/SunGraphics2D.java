...
//                    paintState > PAINT_ALPHACOLOR
    ...
    public static final double MinPenSizeAA =
        ae.sun.java2d.pipe.RenderingEngine.getInstance().getMinimumAAPenSize();
...
// end of text rendering methods
    ...
    */
     ...
     * doc comments for the base method in ae.java.awt.Graphics imply
     ...
     * {@inheritDoc}
     *
     * @see ae.sun.java2d.DestSurfaceProvider#getDestSurface
     */
    @Override
