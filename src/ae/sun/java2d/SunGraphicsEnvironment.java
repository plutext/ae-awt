...
//ae            for (int i=0; i < allfonts.length; i++) {
...
//ae        for (int i=0; i < physicalfonts.length; i++) {
...
//            }
     ...
     * See also ae.java.awt.GraphicsEnvironment.getUsableBounds();
     */
