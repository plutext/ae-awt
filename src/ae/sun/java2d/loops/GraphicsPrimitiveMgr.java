...
public final class GraphicsPrimitiveMgr {
    ...
    static {
        initIDs(GraphicsPrimitive.class,
                ...
                CompositeType.class,
                SunGraphics2D.class,
                ae.java.awt.Color.class,
                ae.java.awt.geom.AffineTransform.class,
                XORComposite.class,
                ae.java.awt.AlphaComposite.class,
                ae.java.awt.geom.Path2D.class,
                ae.java.awt.geom.Path2D.Float.class,
                ae.sun.awt.SunHints.class);
