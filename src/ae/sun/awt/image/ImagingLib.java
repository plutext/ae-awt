...
import ae.java.awt.image.ByteLookupTable;
import ae.java.awt.image.ConvolveOp;
import ae.java.awt.image.Kernel;
import ae.java.awt.image.LookupOp;
import ae.java.awt.image.LookupTable;
import ae.java.awt.image.RasterOp;
    ...
    static {
        ...
        try {
            nativeOpClass[LOOKUP_OP] =
                Class.forName("ae.java.awt.image.LookupOp");
        } catch (ClassNotFoundException e) {
            System.err.println("Could not find class: "+e);
        }
        try {
            nativeOpClass[AFFINE_OP] =
                Class.forName("ae.java.awt.image.AffineTransformOp");
        } catch (ClassNotFoundException e) {
            System.err.println("Could not find class: "+e);
        }
        try {
            nativeOpClass[CONVOLVE_OP] =
                Class.forName("ae.java.awt.image.ConvolveOp");
        } catch (ClassNotFoundException e) {
            System.err.println("Could not find class: "+e);
        }
