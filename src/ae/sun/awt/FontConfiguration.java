...
public abstract class FontConfiguration {
    ...
    private void findFontConfigFile() {
        ...
        String userConfigFile = System.getProperty("ae.sun.awt.fontconfig");
            ...
            for (int styleIndex = 0; styleIndex < NUM_STYLES; styleIndex++) {
                ...
                for (index = 0; index < coreScripts.length; index++) {
                    ...
                    if (preferLocaleFonts && localeMap != null &&
                        ae.sun.font.FontManager.usingAlternateFontforJALocales()) {
    ...
    */
     ...
     * The style argument is interpreted as in ae.java.awt.Font.Font.
     */
    ...
    private CharsetEncoder getFontCharsetEncoder(final String charsetName,
        ...
        if (!charsetName.startsWith("ae.sun.awt.") && !charsetName.equals("default")) {
