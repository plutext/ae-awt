...
//import ae.sun.awt.im.SimpleInputMethodWindow;
import ae.sun.awt.image.*;
...
public abstract class SunToolkit extends Toolkit
    ...
    static {
        if (AccessController.doPrivileged(new GetBooleanAction("ae.sun.awt.nativedebug"))) {
            DebugSettings.init();
        }
    };
    ...
    public abstract ListPeer createList(ae.java.awt.List target)
        throws HeadlessException;
    ...
    public static void checkAndSetPolicy(Container cont, boolean isSwingCont)
    {
        ...
        if (!"ae.sun.awt.X11.XToolkit".equals(toolkitName)) {
        ...
        if (DefaultFocusTraversalPolicy.class != defaultPolicy.getClass()) {
            ...
            if (policyName.startsWith("ae.java.awt.")) {
                // AWT
                if (isSwingCont) {
...
//    }
    ...
    /**
     * @see ae.sun.awt.WindowClosingSupport#getWindowClosingListener
     */
    public WindowClosingListener getWindowClosingListener() {
        return windowClosingListener;
    }
    /**
     * @see ae.sun.awt.WindowClosingSupport#setWindowClosingListener
     */
    ...
    /**
     * @see ae.sun.awt.WindowClosingListener#windowClosingNotify
     */
    ...
    /**
     * @see ae.sun.awt.WindowClosingListener#windowClosingDelivered
     */
