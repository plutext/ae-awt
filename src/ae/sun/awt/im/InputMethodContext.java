...
public class InputMethodContext
       extends ae.sun.awt.im.InputContext
       implements ae.java.awt.im.spi.InputMethodContext {
    ...
    static {
        ...
        String inputStyle = (String) AccessController.doPrivileged
                (new GetPropertyAction("ae.java.awt.im.style", null));
        // get property from awt.properties file
        if (inputStyle == null) {
            inputStyle = Toolkit.getDefaultToolkit().
                    getProperty("ae.java.awt.im.style", null);
        }
   ...
   boolean useBelowTheSpotInput() {
    ...
    // implements ae.java.awt.im.spi.InputMethodContext.dispatchInputMethodEvent
    ...
    // implements ae.java.awt.im.spi.InputMethodContext.createInputMethodWindow
    ...
    // implements ae.java.awt.im.spi.InputMethodContext.createInputMethodJFrame
