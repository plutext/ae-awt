...
import ae.java.awt.im.spi.InputMethod;
 ...
 *
 * @see ae.java.awt.im.InputContext
 * @author JavaSoft Asia/Pacific
 */

public class InputContext extends ae.java.awt.im.InputContext
                          implements ComponentListener, WindowListener {
    private static final Logger log = Logger.getLogger("ae.sun.awt.im.InputContext");
    ...
    /**
     * @see ae.java.awt.im.InputContext#selectInputMethod
    ...
    /**
     * @see ae.java.awt.im.InputContext#getLocale
     */
    ...
    /**
     * @see ae.java.awt.im.InputContext#setCharacterSubsets
     */
    ...
    /**
     * @see ae.java.awt.im.InputContext#dispatchEvent
     */
    ...
    private void focusGained(Component source) {
        ...
        synchronized (source.getTreeLock()) {
            synchronized (this) {
                if ("ae.sun.awt.im.CompositionArea".equals(source.getClass().getName())) {
    ...
    /**
     * @see ae.java.awt.im.InputContext#removeNotify
    ...
    /**
     * @see ae.java.awt.im.InputContext#dispose
     ...
     * @see ae.java.awt.im.spi.InputMethod#setInputMethodContext
     * @see ae.java.awt.im.spi.InputMethod#setLocale
     * @see ae.java.awt.im.spi.InputMethod#setCharacterSubsets
     */
    ...
    private void logCreationFailed(Throwable throwable) {
        ...
        Logger logger = Logger.getLogger("ae.sun.awt.im");
    ...
    /**
     * @see ae.java.awt.im.InputContext#endComposition
     */
    ...
    /**
     * @see ae.java.awt.im.spi.InputMethodContext#enableClientWindowNotification
     */
