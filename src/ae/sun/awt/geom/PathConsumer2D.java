...
public interface PathConsumer2D {
    /**
     * @see ae.java.awt.geom.Path2D.Float.moveTo
     */
    public void moveTo(float x, float y);

    /**
     * @see ae.java.awt.geom.Path2D.Float.lineTo
     */
    public void lineTo(float x, float y);

    /**
     * @see ae.java.awt.geom.Path2D.Float.quadTo
     */
    public void quadTo(float x1, float y1,
                       float x2, float y2);

    /**
     * @see ae.java.awt.geom.Path2D.Float.curveTo
     */
    ...
    /**
     * @see ae.java.awt.geom.Path2D.Float.closePath
     */
