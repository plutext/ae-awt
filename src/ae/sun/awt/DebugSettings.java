...
/*
 * Internal class that manages ae.sun.awt.Debug settings.
 ...
 * system property to 'true': ae.sun.awt.nativedebug. After
 * the native logging is enabled, the actual debug settings
 * are read the same way as described above (as before
 * the fix for 4638447).
 */
final class DebugSettings {
    private static final Logger log = Logger.getLogger("ae.sun.awt.debug.DebugSettings");
