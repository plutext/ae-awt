...
/*
 * Interface between Java Fonts (ae.java.awt.Font) and the underlying
...
public final class FontManager {
    ...
    static {
        ...
        if (SunGraphicsEnvironment.debugFonts) {
            logger = Logger.getLogger("ae.sun.java2d", null);
        ...
        java.security.AccessController.doPrivileged(
           ...
           public Object run() {
               ...
               String t2kStr = System.getProperty("ae.sun.java2d.font.scaler");
               if (t2kStr != null) {
     ...
     * created with ae.java.awt.Font.createFont(..).
...
//     }
     ...
     * return fuir;
     */
//ae    public static FontUIResource getCompositeFontUIResource(Font font) {
//
//        FontUIResource fuir =
...
//    }
    ...
    public static void registerCompositeFont(String compositeName,
         ...
         * that any statically created ae.java.awt.Font instances which already
         ...
         * Swing) has cached a ae.java.awt.Font. Note that if Swing is using
...
//ae            case FontManager.FONTFORMAT_NATIVE:
...
//                physicalFont = addToFontList(nf, fontRank);
    ...
    public static Font2D findFont2D(String name, int style, int fallback) {
         ...
         * the ae.java.awt.Font class internally substitutes this name.
     ...
     * do the lookup once, and subsequent calls on the ae.java.awt.Font
     ...
     * The font lookup mechanism in ae.java.awt.Font.getFont2D() is also updated
     * so that look-up for composite fonts will in that case always
     * do a lookup rather than returning a cached result.
     * This is inefficient but necessary else singleton ae.java.awt.Font
     ...
     * visible ae.java.awt.Font. So in that case the metrics cache which tests
    ...
    */
     ...
     */
//ae    public static FontUIResource getFontConfigFUIR(String fcFamily,
//                                                   int style, int size) {
//
