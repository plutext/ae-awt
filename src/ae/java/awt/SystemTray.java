 ...
 *         // load an image
 *         {@link ae.java.awt.Image} image = {@link ae.java.awt.Toolkit#getImage(String) Toolkit.getDefaultToolkit().getImage}(...);
 *         // create a action listener to listen for default action executed on the tray icon
 *         {@link ae.java.awt.event.ActionListener} listener = new {@link ae.java.awt.event.ActionListener ActionListener}() {
 *             public void {@link ae.java.awt.event.ActionListener#actionPerformed actionPerformed}({@link ae.java.awt.event.ActionEvent} e) {
 *                 // execute default action of the application
 *                 // ...
 *             }
 *         };
 *         // create a popup menu
 *         {@link ae.java.awt.PopupMenu} popup = new {@link ae.java.awt.PopupMenu#PopupMenu PopupMenu}();
 ...
 *         trayIcon = new {@link TrayIcon#TrayIcon(ae.java.awt.Image, String, ae.java.awt.PopupMenu) TrayIcon}(image, "Tray Demo", popup);
 *         // set the TrayIcon properties
 *         trayIcon.{@link TrayIcon#addActionListener(ae.java.awt.event.ActionListener) addActionListener}(listener);
 *         // ...
 *         // add the tray image
 *         try {
 ...
 *     if (trayIcon != null) {
 *         trayIcon.{@link TrayIcon#setImage(ae.java.awt.Image) setImage}(updatedImage);
 *     }
 *     // ...
 * </pre>
 * </code>
