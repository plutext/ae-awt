...
public class TextArea extends TextComponent {
     ...
     * @see        ae.java.awt.TextArea#replaceRange
     * @see        ae.java.awt.TextArea#append
     * @since      JDK1.1
     */
     ...
     * @see       ae.java.awt.TextArea#insert
     * @since     JDK1.1
     */
     ...
     * @see        ae.java.awt.TextArea#SCROLLBARS_BOTH
     * @see        ae.java.awt.TextArea#SCROLLBARS_VERTICAL_ONLY
     * @see        ae.java.awt.TextArea#SCROLLBARS_HORIZONTAL_ONLY
     * @see        ae.java.awt.TextArea#SCROLLBARS_NONE
     * @see        ae.java.awt.TextArea#TextArea(java.lang.String, int, int, int)
     * @since      JDK1.1
     */
     ...
     *                       number of rows and columns
     * @see       ae.java.awt.Component#getPreferredSize
     * @since     JDK1.1
     */
     ...
     *                       the text area with the specified
     *                       number of rows and columns
     * @see       ae.java.awt.Component#getMinimumSize
     * @since     JDK1.1
     */
