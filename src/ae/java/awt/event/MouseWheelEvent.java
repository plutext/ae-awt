 ...
 * @see ae.java.awt.ScrollPane#setWheelScrollingEnabled(boolean)
...
public class MouseWheelEvent extends MouseEvent {
     ...
     * @see MouseEvent#MouseEvent(ae.java.awt.Component, int, long, int, int, int, int, boolean)
     * @see MouseEvent#MouseEvent(ae.java.awt.Component, int, long, int, int, int, int, int, int, boolean, int)
     */
     ...
     *  the native platform.
     * @see ae.java.awt.Adjustable#getUnitIncrement
     * @see ae.java.awt.Adjustable#getBlockIncrement
     ...
     * @see javax.swing.Scrollable#getScrollableUnitIncrement
     * @see ae.java.awt.ScrollPane
     * @see ae.java.awt.ScrollPane#setWheelScrollingEnabled
     * @see javax.swing.JScrollPane
