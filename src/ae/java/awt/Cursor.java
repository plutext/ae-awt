...
public class Cursor implements java.io.Serializable {
    ...
    private static final Logger log = Logger.getLogger("ae.java.awt.Cursor");
    ...
    static class CursorDisposer implements ae.sun.java2d.DisposerRecord {
        volatile long pData;
    ...
    private void setPData(long pData) {
        ...
        if (disposer == null) {
            ...
            ae.sun.java2d.Disposer.addRecord(anchor, disposer);
        } else {
     ...
     * @see ae.java.awt.Toolkit#createCustomCursor
     */
