...
public class Container extends Component {
    ...
    private static final Logger log = Logger.getLogger("ae.java.awt.Container");
    private static final Logger eventLog = Logger.getLogger("ae.java.awt.event.Container");
    ...
    private static final Logger mixingLog = Logger.getLogger("ae.java.awt.mixing.Container");
     ...
     * <code>ae.java.awt.Container.add(Component, int)</code> is that this method
     ...
     *            to a container
     * @see #getComponentZOrder(ae.java.awt.Component)
     * @since 1.5
     */
     ...
     * @see #setComponentZOrder(ae.java.awt.Component, int)
     * @since 1.5
     */
    ...
    public Component locate(int x, int y) {
        ...
        synchronized (getTreeLock()) {
            // Two passes: see comment in ae.sun.awt.SunGraphicsCallback
            for (int i = 0; i < component.size(); i++) {
                Component comp = component.get(i);
                if (comp != null &&
                    !(comp.peer instanceof LightweightPeer)) {
     ...
     * lightweight cursor support in ae.sun.awt.GlobalCursorManager.
...
//ae        Component predictedFocusOwner = (Component.isInstanceOf(this, "javax.swing.JInternalFrame")) ? ((javax.swing.JInternalFrame)(this)).getMostRecentFocusOwner() : null;
