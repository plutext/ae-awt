    ...
    implements Shape, java.io.Serializable
{
     ...
     * @see       ae.java.awt.Component#getBounds
     ...
     * @see       #getBounds
     * @see       ae.java.awt.Component#setBounds(ae.java.awt.Rectangle)
     * @since     1.1
     */
     ...
     * @see       #getBounds
     * @see       ae.java.awt.Component#setBounds(int, int, int, int)
     * @since     1.1
     */
     ...
     * @see       ae.java.awt.Component#getLocation
     ...
     * @see       ae.java.awt.Component#setLocation(ae.java.awt.Point)
     * @see       #getLocation
     * @since     1.1
     */
     ...
     * @see       #getLocation
     * @see       ae.java.awt.Component#setLocation(int, int)
     * @since     1.1
     */
     ...
     *            this <code>Rectangle</code>.
     * @see       ae.java.awt.Component#getSize
     ...
     * @see       ae.java.awt.Component#setSize(ae.java.awt.Dimension)
     * @see       #getSize
     * @since     1.1
     */
     ...
     * @param width the new width for this <code>Rectangle</code>
     * @param height the new height for this <code>Rectangle</code>
     * @see       ae.java.awt.Component#setSize(int, int)
     * @see       #getSize
     * @since     1.1
     */
