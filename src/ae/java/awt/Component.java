...
import ae.sun.awt.EmbeddedFrame;
...
//import ae.sun.awt.im.CompositionArea;
...
import static ae.sun.java2d.pipe.hw.ExtendedBufferCapabilities.VSyncType.*;
                                           ...
                                           Serializable
{
     ...
     *
     * @since 1.4
     * @see ae.java.awt.image.BufferStrategy
...
//        }
     ...
     * @see ae.java.awt.peer.ComponentPeer#getColorModel()
     ...
     * within <code>ae.java.awt.event.ComponentListener.componentMoved()</code>,
     ...
     * {@link ae.java.awt.font.FontRenderContext FontRenderContext} and
     ...
     * @see       #getFont
     * @see       #getPeer
     * @see       ae.java.awt.peer.ComponentPeer#getFontMetrics(Font)
     * @see       Toolkit#getFontMetrics(Font)
     * @since     JDK1.0
     */
    public FontMetrics getFontMetrics(Font font) {
        // REMIND: PlatformFont flag should be obsolete soon...
        if (ae.sun.font.FontManager.usePlatformFontMetrics()) {
            if (peer != null &&
                !(peer instanceof LightweightPeer)) {
                return peer.getFontMetrics(font);
            }
        }
        return ae.sun.font.FontDesignMetrics.getMetrics(font);
    }
    ...
    /**
     * Simulates the peer callbacks into ae.java.awt for painting of
    ...
    /**
     * Simulates the peer callbacks into ae.java.awt for printing of
     * lightweight Components.
     * @param     g   the graphics context to use for printing
     * @see       #printAll
     */
     ...
     * @see     Graphics#drawImage(Image, int, int, Color, ae.java.awt.image.ImageObserver)
     * @see     Graphics#drawImage(Image, int, int, ae.java.awt.image.ImageObserver)
     * @see     Graphics#drawImage(Image, int, int, int, int, Color, ae.java.awt.image.ImageObserver)
     * @see     Graphics#drawImage(Image, int, int, int, int, ae.java.awt.image.ImageObserver)
     ...
     *    <code>GraphicsEnvironment.isHeadless()</code> returns
     *    <code>true</code>.
     * @see ae.java.awt.image.VolatileImage
     * @see #isDisplayable
     * @see GraphicsEnvironment#isHeadless
     * @since     1.4
     */
     ...
     * @see      #prepareImage(Image, int, int, ae.java.awt.image.ImageObserver)
     * @see      Toolkit#checkImage(Image, int, int, ae.java.awt.image.ImageObserver)
     * @see      ae.java.awt.image.ImageObserver
     * @since    JDK1.0
     */
     ...
     *
     * @see ae.sun.awt.SunGraphicsEnvironment#isFlipStrategyPreferred(ComponentPeer)
     */
    ...
    protected class FlipBufferStrategy extends BufferStrategy {
         ...
         * <code>true</code>.
         * @see ae.java.awt.BufferCapabilities#isPageFlipping()
         */
         ...
         * @exception IllegalStateException if the buffers have not yet
         * been created
         * @see ae.java.awt.BufferCapabilities#getFlipContents()
         */
     ...
     * specified point.
     * @param     p   the point
     * @see       ae.java.awt.Component#contains
     * @since     JDK1.1
     */
    ...
    void dispatchEventImpl(AWTEvent e) {
         ...
         */
        if (!e.isConsumed()) {
            if (e instanceof ae.java.awt.event.KeyEvent) {
...
//ae            if(((e instanceof InputMethodEvent)
//            		&& !(this instanceof CompositionArea)
//            		)
//               ||
...
//ae            if (id == FocusEvent.FOCUS_GAINED) {
//                InputContext inputContext = getInputContext();
//                if (inputContext != null && inputContext instanceof ae.sun.awt.im.InputContext) {
//                    ((ae.sun.awt.im.InputContext)inputContext).disableNativeIM();
//                }
//            }
        }
     ...
     * @see      ae.java.awt.event.ComponentListener
     ...
     * @see      ae.java.awt.event.HierarchyListener
     ...
     * @see      ae.java.awt.event.HierarchyEvent
     * @see      ae.java.awt.event.HierarchyBoundsListener
    ...
    /*
     * Should only be called while holding the tree lock.
     * It's added only for overriding in ae.java.awt.Window
     ...
     * @see      ae.java.awt.event.KeyListener
     ...
     * @see      ae.java.awt.event.MouseListener
     ...
     * @see      ae.java.awt.event.MouseEvent
     * @see      ae.java.awt.event.MouseMotionListener
     ...
     * @see      ae.java.awt.event.MouseWheelListener
     ...
     * @see      ae.java.awt.event.InputMethodListener
     ...
     * @since 1.2
     */
//ae    public InputMethodRequests getInputMethodRequests() {
//        return null;
//    }
...
//    }
    ...
    transient ae.sun.awt.EventQueueItem[] eventCache;
     ...
     * @see         ae.java.awt.event.FocusEvent
     * @see         ae.java.awt.event.FocusListener
     * @see         ae.java.awt.KeyboardFocusManager
     * @see         #addFocusListener
     * @see         #enableEvents
     * @see         #dispatchEvent
     * @since       JDK1.1
     ...
     * @see         ae.java.awt.event.KeyListener
     * @see         ae.java.awt.KeyboardFocusManager
     * @see         ae.java.awt.DefaultKeyboardFocusManager
     * @see         #processEvent
     * @see         #dispatchEvent
     * @see         #addKeyListener
     * @see         #enableEvents
    ...
    public void removeNotify() {
        ...
        synchronized (getTreeLock()) {
            ...
            // before hiding peer.)
//ae            if ((eventMask & AWTEvent.INPUT_METHODS_ENABLED_MASK) != 0) {
//                InputContext inputContext = getInputContext();
//                if (inputContext != null) {
//                    inputContext.removeNotify(this);
//                }
//            }
    ...
    final Component getNextFocusCandidate() {
        ...
        if (rootAncestor != null) {
            ...
            if (toFocus == null) {
//ae                Applet applet = EmbeddedFrame.getAppletIfAncestorOf(this);
//                if (applet != null) {
//                    toFocus = applet;
//                }
            }
    ...
    protected abstract class AccessibleAWTComponent extends AccessibleContext
         ...
         * return <code>ae.java.awt.Component.getName()</code>,
         ...
         * @see ae.javax.accessibility.AccessibleContext#setAccessibleName
         */
         ...
         * @see ae.javax.accessibility.AccessibleContext#setAccessibleDescription
         */
...
//ae            if (Component.isInstanceOf(this, "javax.swing.JComponent")) {
