...
public class Menu extends MenuItem implements MenuContainer, Accessible {
     ...
     * @see         ae.java.awt.Menu#insert(java.lang.String, int)
     * @see         ae.java.awt.Menu#insert(ae.java.awt.MenuItem, int)
     */
     ...
     * @see           ae.java.awt.Menu#add(java.lang.String)
     * @see           ae.java.awt.Menu#add(ae.java.awt.MenuItem)
     ...
     * @see         ae.java.awt.Menu#insertSeparator(int)
     */
     ...
     * @see         ae.java.awt.Menu#addSeparator
     * @since       JDK1.1
     */
