...
public class MediaTracker implements java.io.Serializable {
     ...
     * @see         ae.java.awt.MediaTracker#statusAll
     * @see         ae.java.awt.MediaTracker#statusID
     */
     ...
     * @see         ae.java.awt.MediaTracker#checkAll(boolean)
     * @see         ae.java.awt.MediaTracker#checkID
     * @see         ae.java.awt.MediaTracker#isErrorAny
     * @see         ae.java.awt.MediaTracker#isErrorID
     */
     ...
     *                       an error; <code>false</code> otherwise
     * @see         ae.java.awt.MediaTracker#checkID
     * @see         ae.java.awt.MediaTracker#checkAll()
     * @see         ae.java.awt.MediaTracker#isErrorAny()
     * @see         ae.java.awt.MediaTracker#isErrorID(int)
     */
     ...
     * @see      ae.java.awt.MediaTracker#isErrorID
     * @see      ae.java.awt.MediaTracker#getErrorsAny
     */
     ...
     * @see          ae.java.awt.MediaTracker#isErrorAny
     * @see          ae.java.awt.MediaTracker#getErrorsID
     */
     ...
     * <code>isErrorAny</code> or <code>isErrorID</code> methods to
     * check for errors.
     * @see         ae.java.awt.MediaTracker#waitForID(int)
     * @see         ae.java.awt.MediaTracker#waitForAll(long)
     * @see         ae.java.awt.MediaTracker#isErrorAny
     * @see         ae.java.awt.MediaTracker#isErrorID
     ...
     * @see          ae.java.awt.MediaTracker#statusID(int, boolean)
     * @see          ae.java.awt.MediaTracker#LOADING
     * @see          ae.java.awt.MediaTracker#ABORTED
     * @see          ae.java.awt.MediaTracker#ERRORED
     * @see          ae.java.awt.MediaTracker#COMPLETE
     */
     ...
     *                       have been aborted, or have encountered
     *                       an error; <code>false</code> otherwise
     * @see         ae.java.awt.MediaTracker#checkID(int, boolean)
     * @see         ae.java.awt.MediaTracker#checkAll()
     * @see         ae.java.awt.MediaTracker#isErrorAny()
     * @see         ae.java.awt.MediaTracker#isErrorID(int)
     */
     ...
     * check for errors.
     * @param         id   the identifier of the images to check
     * @see           ae.java.awt.MediaTracker#waitForAll
     * @see           ae.java.awt.MediaTracker#isErrorAny()
     * @see           ae.java.awt.MediaTracker#isErrorID(int)
     * @exception     InterruptedException  if any thread has
     *                          interrupted this thread.
     ...
     * @see          ae.java.awt.MediaTracker#statusAll(boolean)
     * @see          ae.java.awt.MediaTracker#LOADING
     * @see          ae.java.awt.MediaTracker#ABORTED
     * @see          ae.java.awt.MediaTracker#ERRORED
     * @see          ae.java.awt.MediaTracker#COMPLETE
     ...
     * @see     ae.java.awt.MediaTracker#removeImage(ae.java.awt.Image, int)
     * @see     ae.java.awt.MediaTracker#removeImage(ae.java.awt.Image, int, int, int)
     * @since   JDK1.1
     */
     ...
     * @see        ae.java.awt.MediaTracker#removeImage(ae.java.awt.Image)
     * @see        ae.java.awt.MediaTracker#removeImage(ae.java.awt.Image, int, int, int)
     * @since      JDK1.1
     */
