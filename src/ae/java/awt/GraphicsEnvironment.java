 ...
 * of {@link GraphicsDevice} objects and {@link ae.java.awt.Font} objects
...
public abstract class GraphicsEnvironment {
     ...
     */
    private static Boolean headless = Boolean.TRUE; //ae

    /**
     * The headless state assumed by default
     */
    private static Boolean defaultHeadless = Boolean.TRUE; //ae
    ...
    public static synchronized GraphicsEnvironment getLocalGraphicsEnvironment() {
        if (localEnv == null) {
//ae            String nm = (String) java.security.AccessController.doPrivileged
//                (new sun.security.action.GetPropertyAction
//                 ("ae.java.awt.graphicsenv", null));
//
//            try {
...
//            }
     ...
     * otherwise
     * @see ae.java.awt.HeadlessException
     * @since 1.4
     */
    ...
    /**
     * @return the value of the property "ae.java.awt.headless"
     * @since 1.4
     */
    private static boolean getHeadlessProperty() {
        if (headless == null) {
            ...
            new java.security.PrivilegedAction() {
                public Object run() {
                    String nm = System.getProperty("ae.java.awt.headless");
     ...
     * @see ae.java.awt.Font#deriveFont
     * @see ae.java.awt.Font#getFontName
     * @since 1.2
     */
     ...
     * @see #getAllFonts
     * @see ae.java.awt.Font
     * @see ae.java.awt.Font#getFamily
     * @since 1.2
     */
    ...
    public boolean registerFont(Font font) {
        ...
        return ae.sun.font.FontManager.registerFont(font);
    }
    ...
    public void preferLocaleFonts() {
        ae.sun.font.FontManager.preferLocaleFonts();
    }
    ...
    public void preferProportionalFonts() {
        ae.sun.font.FontManager.preferProportionalFonts();
    }
