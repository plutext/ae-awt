 ...
 * @see     ae.java.awt.Graphics#clipRect(int, int, int, int)
 ...
 * @see     ae.java.awt.Graphics#setFont(ae.java.awt.Font)
 * @since       JDK1.0
 */
public abstract class Graphics {
     ...
     * @see        ae.java.awt.Graphics#translate
     * @see        ae.java.awt.Graphics#clipRect
     */
     ...
     * @see       ae.java.awt.Color
     * @see       ae.java.awt.Graphics#setColor(Color)
     */
     ...
     * @see       ae.java.awt.Color
     * @see       ae.java.awt.Graphics#getColor
     */
     ...
     * @see       ae.java.awt.Graphics#setFont(Font)
     */
     ...
     * @param  font   the font.
     * @see     ae.java.awt.Graphics#getFont
     * @see     ae.java.awt.Graphics#drawString(java.lang.String, int, int)
     * @see     ae.java.awt.Graphics#drawBytes(byte[], int, int, int, int)
     * @see     ae.java.awt.Graphics#drawChars(char[], int, int, int, int)
    */
     ...
     * @see       ae.java.awt.Graphics#getFontMetrics(Font)
     */
     ...
     * @see       ae.java.awt.Graphics#getFont
     * @see       ae.java.awt.FontMetrics
     * @see       ae.java.awt.Graphics#getFontMetrics()
     */
     ...
     * @see         ae.java.awt.Graphics#getClip
     * @see         ae.java.awt.Graphics#clipRect
     * @see         ae.java.awt.Graphics#setClip(int, int, int, int)
     * @see         ae.java.awt.Graphics#setClip(Shape)
     * @since       JDK1.1
     */
     ...
     *              no clip is set.
     * @see         ae.java.awt.Graphics#getClipBounds
     * @see         ae.java.awt.Graphics#clipRect
     * @see         ae.java.awt.Graphics#setClip(int, int, int, int)
     * @see         ae.java.awt.Graphics#setClip(Shape)
     * @since       JDK1.1
     ...
     * @see           ae.java.awt.Graphics#clearRect
     ...
     * @see          ae.java.awt.Graphics#fillRect
     * @see          ae.java.awt.Graphics#clearRect
     */
     ...
     *                    at the four corners.
     * @see        ae.java.awt.Graphics#fillRoundRect
     */
     ...
     *                     of the arc at the four corners.
     * @see         ae.java.awt.Graphics#drawRoundRect
     */
     ...
     * @see         ae.java.awt.Graphics#fill3DRect
     */
     ...
     * @see         ae.java.awt.Graphics#draw3DRect
     */
     ...
     * @see         ae.java.awt.Graphics#fillOval
     */
     ...
     * @see         ae.java.awt.Graphics#drawOval
     */
     ...
     * @see         ae.java.awt.Graphics#fillArc
     */
     ...
     * @param        arcAngle the angular extent of the arc,
     *                    relative to the start angle.
     * @see         ae.java.awt.Graphics#drawArc
     */
     ...
     * @see         ae.java.awt.Graphics#drawPolygon(int[], int[], int)
     * @since       JDK1.1
     */
     ...
     * @see          ae.java.awt.Graphics#fillPolygon
     * @see          ae.java.awt.Graphics#drawPolyline
     */
     ...
     * @see         ae.java.awt.Graphics#drawBytes
     * @see         ae.java.awt.Graphics#drawChars
     */
     ...
     * {@link ae.java.awt.font.TextAttribute TextAttribute} class.
     * <p>
   ...
   public abstract void drawString(AttributedCharacterIterator iterator,
     ...
     * @see         ae.java.awt.Graphics#drawBytes
     * @see         ae.java.awt.Graphics#drawString
     */
