...
class EventDispatchThread extends Thread {
     ...
     *
     * <p> If the system property "ae.sun.awt.exception.handler" is defined, then
     ...
     * event-dispatch thread.  The magic "ae.sun.awt.exception.handler" property
        ...
        public FilterAction acceptEvent(AWTEvent event) {
            if (modalComponent != null) {
                ...
                if (mouseEvent || actionEvent || windowClosingEvent) {
                    ...
                    if (o instanceof ae.sun.awt.ModalExclude) {
                        ...
                        if (modalComponent instanceof Container) {
                            while (c != modalComponent && c != null) {
                                if ((c instanceof Window) &&
                                    (ae.sun.awt.SunToolkit.isModalExcluded((Window)c))) {
