...
public class CardLayout implements LayoutManager2,
    ...
    */
     ...
     * @see       ae.java.awt.CardLayout#setHgap(int)
     * @see       ae.java.awt.CardLayout#getVgap()
     * @since     JDK1.1
     */
    public int getHgap() {
        return hgap;
     ...
     * @see       ae.java.awt.CardLayout#getHgap()
     * @see       ae.java.awt.CardLayout#setVgap(int)
     * @since     JDK1.1
     */
     ...
     *                                        card in the layout.
     * @see       ae.java.awt.CardLayout#show(ae.java.awt.Container, java.lang.String)
     ...
     * @see     ae.java.awt.Container#remove(ae.java.awt.Component)
     * @see     ae.java.awt.Container#removeAll()
     */
     ...
     * @see     ae.java.awt.Container#getPreferredSize
     * @see     ae.java.awt.CardLayout#minimumLayoutSize
     */
     ...
     * @see       ae.java.awt.Container#doLayout
     * @see       ae.java.awt.CardLayout#preferredLayoutSize
     */
     ...
     * @param     parent   the parent container in which to do the layout
     * @see       ae.java.awt.CardLayout#last
     */
     ...
     * @param     parent   the parent container in which to do the layout
     * @see       ae.java.awt.CardLayout#previous
     */
     ...
     * @param     parent   the parent container in which to do the layout
     * @see       ae.java.awt.CardLayout#next
     */
     ...
     * @param     parent   the parent container in which to do the layout
     * @see       ae.java.awt.CardLayout#first
     */
     ...
     * @see       ae.java.awt.CardLayout#addLayoutComponent(ae.java.awt.Component, java.lang.Object)
     */
