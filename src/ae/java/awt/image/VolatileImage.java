 ...
 * by using the {@link ae.java.awt.Component#createVolatileImage(int, int)
 * Component.createVolatileImage} or
 * {@link ae.java.awt.GraphicsConfiguration#createCompatibleVolatileImage(int, int)
...
public abstract class VolatileImage extends Image implements Transparency
{
     ...
     * @see ae.java.awt.GraphicsConfiguration#createCompatibleVolatileImage(int,
     *      int,int)
     * @see ae.java.awt.GraphicsConfiguration#createCompatibleVolatileImage(int,
