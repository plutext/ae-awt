 ...
 * @see BufferedImage
 * @see RenderedImage
 * @see ae.java.awt.color.ColorSpace
 * @see SampleModel
 * @see Raster
 * @see DataBuffer
 */
public abstract class ColorModel implements Transparency{
    ...
    /**
     * This is copied from ae.java.awt.Toolkit since we need the library
     * loaded in ae.java.awt.image also:
     *
     ...
     * ae.java.awt.Transparency.TRANSLUCENT.  The transfer type will be the
