 ...
 * @see ae.java.awt.image.DataBuffer
 * @see ae.java.awt.image.SampleModel
 * @see ae.java.awt.image.PixelInterleavedSampleModel
 * @see ae.java.awt.image.BandedSampleModel
 * @see ae.java.awt.image.SinglePixelPackedSampleModel
 * @see ae.java.awt.image.MultiPixelPackedSampleModel
 */
public class Raster {
     ...
     * @see ae.java.awt.image.SampleModel#getDataElements(int, int, Object, DataBuffer)
     ...
     * A ClassCastException will be thrown if the input object is non null
     * and references anything other than an array of TransferType.
     * @see ae.java.awt.image.SampleModel#getDataElements(int, int, int, int, Object, DataBuffer)
