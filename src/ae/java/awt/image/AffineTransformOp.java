 ...
 * @see ae.java.awt.RenderingHints#KEY_INTERPOLATION
 * @see ae.java.awt.RenderingHints#KEY_RENDERING
 * @see ae.java.awt.RenderingHints#KEY_COLOR_RENDERING
 * @see ae.java.awt.RenderingHints#KEY_DITHERING
 */
public class AffineTransformOp implements BufferedImageOp, RasterOp {
    ...
    public final BufferedImage filter(BufferedImage src, BufferedImage dst) {
        ...
        if (needToConvert) {
            ...
            ae.java.awt.Graphics2D g = origDst.createGraphics();
            try {
