...
import ae.java.awt.datatransfer.FlavorMap;
import ae.java.awt.datatransfer.SystemFlavorMap;
import ae.java.awt.dnd.peer.DropTargetPeer;
...
public class DropTarget implements DropTargetListener, Serializable {
     ...
     * <P>
     * @see ae.java.awt.dnd.DnDConstants
     */
     ...
     *
     **********************************************************************
     * This method is usually called from ae.java.awt.Component.addNotify() of
     ...
     *
     **********************************************************************
     * This method is usually called from ae.java.awt.Component.removeNotify() of
     * the Component associated with this DropTarget to notify the DropTarget
...
//ae            timer  = new Timer(interval.intValue(), this);
//
...
//ae            if (Math.abs(locn.x - prev.x) > hysteresis ||
